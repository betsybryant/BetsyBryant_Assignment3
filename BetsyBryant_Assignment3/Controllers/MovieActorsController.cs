...
namespace BetsyBryant_Assignment3.Controllers
{
    public class MovieActorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MovieID,ActorID")] MovieActor movieActor)
        {
            ...
            ViewData["ActorID"] = new SelectList(_context.Actor, "ActorId", "ActorName", movieActor.ActorID);
            ViewData["MovieID"] = new SelectList(_context.Movie, "MovieId", "MovieTitle", movieActor.MovieID);
            return View(movieActor);
        }
